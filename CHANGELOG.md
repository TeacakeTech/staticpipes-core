...
* Catch and log exceptions thrown in pipes during build, with new config option `on_build_exception_continue` to continue or not https://github.com/TeacakeTech/staticpipes-core/issues/6

### Removed

- Dropped support for Python 3.10 as that isn't supported anymore.
